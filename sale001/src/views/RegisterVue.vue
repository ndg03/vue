...
<div class="warp">
        <div class="center">
          ...
          <div class="cen">
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm" style="width: 1250px">
              <el-row>
                <el-col span="8" offset="0">
                  ...
                  <el-form-item>
                    <el-button  @click="submitForm('ruleForm')" class="btn">立即开通</el-button>
                  </el-form-item>
                </el-col>
              </el-row>
            </el-form>
